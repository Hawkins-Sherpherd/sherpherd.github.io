...
<script>
    ...
    const marker_gz = L.marker(loc_gz).addTo(map).bindPopup("<b>DN42:</b> gz1.sherpherd.dn42<br><b>Clearnet:</b> gz1.sherpherd.top<br><b>Location:</b> Guangzhou, Guangdong Province China<br><b>Bandwidth:</b> 200Mbps<br><br><b>MPLS Enabled</b><br>");
    ...
    const link_gz1_us1 = L.polyline(curve_point_gz1_us1, {color: 'red', opacity: 0.2, dashArray: '5, 5'}).addTo(map).bindPopup("<b>Link Name: </b>GZ1 == US1<br><br><b>Estimated RTT Latency:</b> 180ms<hr><b>Temporary Unavailable</b>");
