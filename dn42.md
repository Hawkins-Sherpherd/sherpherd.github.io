...
<script>
    ...
    const link_jp1_us1 = L.polyline(curve_point_jp1_us1, {color: 'red', opacity: 0.2, dashArray: '5, 5'}).addTo(map).bindPopup("<b>Link Name: </b>JP1 == US1<br><br><b>Estimated RTT Latency:</b> 105ms<hr><b>Temporary Unavailable</b>");
</script>
