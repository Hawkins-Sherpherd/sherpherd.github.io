...
<script>
    ...
    var marker_dg = L.marker([22.965174, 113.985659]).addTo(map).bindPopup("<b>DN42:</b> dg1.sherpherd.dn42<br><b>Clearnet:</b> dg1.dn42.sherpherd.top<br><b>Location:</b> Dongguan, Guangdong Province, China<br><b>Bandwidth:</b> 30Mbps<br><br><b>MPLS Enabled</b><br>");
    var marker_hk = L.marker([22.2793278, 114.1628131]).addTo(map).bindPopup("<b>DN42:</b> hk1.sherpherd.dn42<br><b>Clearnet:</b> hk1.dn42.sherpherd.top<br><b>Location:</b> Hong Kong, China<br><b>Bandwidth:</b> 30Mbps<br><br><b>MPLS Enabled</b><hr><b>DN42:</b> hk2.sherpherd.dn42<br><b>Clearnet:</b> hk2.dn42.sherpherd.top<br><b>Location:</b> Hong Kong, China<br><b>Bandwidth:</b> 5Gbps<br><br><b>MPLS Enabled</b><br>");
    var marker_kr = L.marker([37.5666791, 126.9782914]).addTo(map).bindPopup("<b>DN42:</b> kr-sel1.sherpherd.dn42<br><b>Clearnet:</b> kr-sel1.dn42.sherpherd.top<br><b>Location:</b> Seoul, South Korea<br><b>Bandwidth:</b> 1Gbps<br><br><b>MPLS Enabled</b><br>");
    var marker_us1 = L.marker([34.0536909, -118.242766]).addTo(map).bindPopup("<b>DN42:</b> us-lax1.sherpherd.dn42<br><b>Clearnet:</b> us-lax1.dn42.sherpherd.top<br><b>Location:</b> Los Angeles, CA, United States<br><b>Bandwidth:</b> 1Gbps<br><br><b>MPLS Enabled</b><br>");
    var marker_de = L.marker([50.1106444, 8.6820917]).addTo(map).bindPopup("<b>DN42:</b> de-fra1.sherpherd.dn42<br><b>Clearnet:</b> de-fra1.dn42.sherpherd.top<br><b>Location:</b> Frankfurt, Germany<br><b>Bandwidth:</b> 200Mbps<br><br><b>MPLS Enabled</b><br>");
    var marker_us2 = L.marker([40.0757384, -74.4041622]).addTo(map).bindPopup("<b>DN42:</b> us-nyc1.sherpherd.dn42<br><b>Clearnet:</b> us-nyc1.dn42.sherpherd.top<br><b>Location:</b> NJ, United States<br><b>Bandwidth:</b> 1Gbps<br><br><b>MPLS Enabled</b><br>");
    var marker_sh1 = L.marker([31.2323437, 121.4691024]).addTo(map).bindPopup("<b>DN42:</b> sh1.sherpherd.dn42<br><b>Clearnet:</b> sh1.dn42.sherpherd.top<br><b>Location:</b> Shanghai, China<br><b>Bandwidth:</b> 50Mbps<br><b>Traffic quota strained node, hot potato routing policy applied</b><br><br><b>MPLS Enabled</b><br>");
    var marker_jp1 = L.marker([35.6821936, 139.762221]).addTo(map).bindPopup("<b>DN42:</b> jp-tyo1.sherpherd.dn42<br><b>Clearnet:</b> jp-tyo1.dn42.sherpherd.top<br><b>Location:</b> Tokyo, Japan<br><b>Bandwidth:</b> 500Mbps<br><br><b>MPLS Enabled</b><br>");
    var marker_tr1 = L.marker([41.006381, 28.9758715]).addTo(map).bindPopup("<b>DN42:</b> tr-ist1.sherpherd.dn42<br><b>Clearnet:</b> tr-ist1.dn42.sherpherd.top<br><b>Location:</b> Istanbul, Turkey<br><b>Bandwidth:</b> 10Mbps<br><br><b>MPLS Enabled</b><br>");
...
<table style="font-size: 0.8rem; line-height:2.0">
    ...
    <tr>
        ...
        <td>美国，加州，洛杉矶</td>
        <td>us-lax1.dn42.sherpherd.top</td>
    ...
    <tr>
        ...
        <td>德国，法兰克福</td>
        <td>de-fra1.dn42.sherpherd.top</td>
    ...
    <tr>
        ...
        <td>香港</td>
        <td>hk2.dn42.sherpherd.top</td>
        <td>172.20.209.68, fe80::3947:10</td>
        <td>yKC9BCd6DShGsW+jV/dcXlwagKmENj2gXAIg1smRy3A=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td>Wireguard, Plain GRE/GRETAP, Zerotier</td>
        <td>默认</td>
        <td>默认</td>
    ...
    <tr>
        <td>tr-ist1.sherpherd.dn42</td>
        <td>土耳其，伊斯坦布尔</td>
        <td>tr-ist1.dn42.sherpherd.top</td>
        <td>172.20.209.90, fe80::3947:11</td>
        <td>hZ6BePJa/WWDdtFIqK5QVEgAXkIo94c8JDXYFOgLZng=</td>
        <td>Extended Nexthop, MP-BGP</td>
        <td>Wireguard, Plain GRE/GRETAP, Zerotier</td>
        <td>默认</td>
        <td>默认</td>
