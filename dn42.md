...
<script>
    ...
    const control_point_kr1_us1 = getControlPoint(loc_kr, loc_us1, 1, 0.2);
    ...
    const marker_kr = L.marker(loc_kr).addTo(map).bindPopup("<b>DN42:</b> kr1.sherpherd.dn42<br><b>Clearnet:</b> kr1.sherpherd.top<br><b>Location:</b> Seoul, South Korea<br><b>Bandwidth:</b> 1Gbps<br><br><b>MPLS Enabled</b><br>");
    ...
    const link_us1_us2 = L.polyline([loc_us1,loc_us2], {color: 'red', opacity: 0.2, dashArray: '5, 5'}).addTo(map).bindPopup("<b>Link Name: </b>US1 == US2<br><br><b>Estimated RTT Latency:</b> 70ms<hr><b>Temporary Unavailable</b>");
    ...
    const link_us1_hk1 = L.polyline(curve_point_us1_hk, {color: 'red', opacity: 0.2, dashArray: '5, 5'}).addTo(map).bindPopup("<b>Link Name: </b>US1 == HK1<br><br><b>Estimated RTT Latency:</b> 175ms<hr><b>Temporary Unavailable</b>");
    const link_us1_jp1 = L.polyline(curve_point_us1_jp1, {color: 'red', opacity: 0.2, dashArray: '5, 5'}).addTo(map).bindPopup("<b>Link Name: </b>US1 == JP1<br><br><b>Estimated RTT Latency:</b> 105ms<hr><b>Temporary Unavailable</b>");
    ...
    const link_sh1_us1 = L.polyline(curve_point_sh1_us1, {color: 'red', opacity: 0.2, dashArray: '5, 5'}).addTo(map).bindPopup("<b>Link Name: </b>SH1 == US1<br><br><b>Estimated RTT Latency:</b> 130ms<hr><b>Temporary Unavailable</b>");
    ...
    const link_kr1_de1 = L.polyline(curve_point_kr1_de1, {opacity: 0.8}).addTo(map).bindPopup("<b>Link Name: </b>KR1 == DE1<br><br><b>Estimated RTT Latency:</b> 250ms");
    ...
    const link_kr1_us1 = L.polyline(curve_point_kr1_us1, {color: 'red', opacity: 0.2, dashArray: '5, 5'}).addTo(map).bindPopup("<b>Link Name: </b>KR1 == US1<br><br><b>Estimated RTT Latency:</b> 120ms<hr><b>Temporary Unavailable</b>");
</script>
